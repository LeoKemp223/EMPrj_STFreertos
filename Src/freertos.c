...
void MX_FREERTOS_Init(void) {
  ...
  /* definition and creation of ProTask */
  osThreadDef(ProTask, StartProTask, osPriorityIdle, 0, 128);
  ProTaskHandle = osThreadCreate(osThread(ProTask), NULL);

  /* definition and creation of CtlTask */
  osThreadDef(CtlTask, StartCtlTask, osPriorityIdle, 0, 128);
  CtlTaskHandle = osThreadCreate(osThread(CtlTask), NULL);
...
/* USER CODE BEGIN Header_StartProTask */
/**
* @brief Function implementing the ProTask thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_StartProTask */
void StartProTask(void const * argument)
{
  /* USER CODE BEGIN StartProTask */
  /* Infinite loop */
  for(;;)
  {
    osDelay(1);
  }
  /* USER CODE END StartProTask */
}

/* USER CODE BEGIN Header_StartCtlTask */
/**
* @brief Function implementing the CtlTask thread.
* @param argument: Not used
* @retval None
*/
